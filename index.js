...
alert("Hôm này mùng 8/3 xin chúc cậu luôn mạnh khỏe hạnh phúc, gặp nhiều may mắn, ngày càng phát huy sự xinh đẹp và đặc biệt giữ cho mình chất BÁO :>>> (from MTL with love <3333)")
alert("Nhấn vào con thỏ nhá :33")
...
TweenLite.set("#container",{perspective:900})
